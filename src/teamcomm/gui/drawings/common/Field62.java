 ...
 */
public class Field62 extends Static {

    @Override
    protected void init(GL2 gl) {
        RoSi2Loader.getInstance().cacheModels(gl, new String[]{"field62"});
        setActive(false);
    }
    ...
    public void draw(final GL2 gl, final Camera camera) {
        ...
        gl.glCallList(RoSi2Loader.getInstance().loadModel(gl, "field62"));
